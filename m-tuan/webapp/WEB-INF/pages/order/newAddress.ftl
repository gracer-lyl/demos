...
<!--顶部-->
<header>
	<a href="javascript:void(0)" onclick="_gaq.push(['_trackEvent', 'buy_order', 'click', ''])"
	  class="noDirect return returnBack"><span class="return-txt"><#if deliverList?exists>地址列表<#else>提交订单</#if></span></a>新地址
</header>
<!--顶部 end-->
